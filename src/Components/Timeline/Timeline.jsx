...
const Timeline = () => {
  return (
    <div>
      <section
        class="history-area history-bg has-animation jarallax manuel2022"
        data-background="assets/img/bg/history_bg.jpg"
      >
        <div class="container">
            ...
            <div class="row history-active">
              <div class="col-lg-3">
                <div class="history-item">
                  ...
                  <div class="history-content">
                    <h2 class="title">
                      We already branches across the country
                    </h2>
                    <p>
                      Lorem dolor consectetur tellus suspendisse nulla aliquam
                      at the ultrices the pretium
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="history-item">
                  ...
                  <div class="history-content">
                    <h2 class="title">
                      Cleaning Authority for a Free Estimate
                    </h2>
                    <p>
                      Lorem dolor consectetur tellus suspendisse nulla aliquam
                      at the ultrices the pretium
