                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            <div class="counter-item">
                                ...
                                <div class="content">
                                    <h2 class="count"><span class="odometer" data-count="2562"></span>2562 +</h2>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="counter-item">
                                ...
                                <div class="content">
                                    <h2 class="count"><span class="odometer" data-count="176"></span>176 +</h2>
                                    <p>Active Project</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <div class="counter-item">
                                ...
                                <div class="content">
                                    <h2 class="count"><span class="odometer" data-count="28"></span>28 +</h2>
                                    <p>Winning Award</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <div class="counter-item">
                                ...
                                <div class="content">
                                    <h2 class="count"><span class="odometer" data-count="150"></span>150 +</h2>
                                    <p>Expert Teams</p>
                                </div>
                            </div>
                        </div>
